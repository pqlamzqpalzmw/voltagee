...
document.addEventListener('DOMContentLoaded', () => {
  ...
  startScreen.addEventListener('click', () => {
    ...
    backgroundVideo.play().catch(err => {
      console.error("Failed to play video with sound after start screen click:", err);
    });
  ...
  startScreen.addEventListener('touchstart', (e) => {
    ...
    backgroundVideo.loop = true;
    backgroundVideo.play().catch(err => {
      console.error("Failed to play video with sound after start screen touch:", err);
    });
    profileBlock.classList.remove('hidden');
    gsap.fromTo(profileBlock,
      { opacity: 0, y: -50 },
  ...
  const musicPlayerEl = document.getElementById('volume-icon');
  const musicSliderEl = document.getElementById('volume-slider');
  if (musicPlayerEl) musicPlayerEl.style.display = 'none';
  if (musicSliderEl) musicSliderEl.style.display = 'none';
  ...
  function switchTheme(videoSrc, themeClass, overlay = null, overlayOverProfile = false) {
    ...
    gsap.to(backgroundVideo, {
      ...
      onComplete: () => {
        ...
        backgroundVideo.muted = false;
        backgroundVideo.volume = 1;
        backgroundVideo.play().catch(err => console.error("Failed to play theme video:", err));
  ...
  hackerButton.addEventListener('click', () => {
    switchTheme('assets/hacker_background.mp4', 'hacker-theme', hackerOverlay, false);
  });
  ...
  rainButton.addEventListener('click', () => {
    switchTheme('assets/rain_background.mov', 'rain-theme', snowOverlay, true);
  });
  ...
  animeButton.addEventListener('click', () => {
    switchTheme('assets/anime_background.mp4', 'anime-theme');
  });
  ...
  carButton.addEventListener('click', () => {
    switchTheme('assets/car_background.mp4', 'car-theme');
  });
